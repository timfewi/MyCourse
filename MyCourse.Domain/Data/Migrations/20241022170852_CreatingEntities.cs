    ...
    public partial class CreatingEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationMedias", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ApplicationMedias_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationMedias_Medias_MediaId",
                        column: x => x.MediaId,
                        principalTable: "Medias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationMedias_ApplicationId",
                table: "ApplicationMedias",
                column: "ApplicationId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationMedias_MediaId",
                table: "ApplicationMedias",
                column: "MediaId");
