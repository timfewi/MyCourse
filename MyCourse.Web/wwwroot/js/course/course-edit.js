// Datei: wwwroot/js/course/course-edit.js

document.addEventListener('DOMContentLoaded', function () {

    // Initialisierung von DataTables (falls benötigt)
    ...
    function updateFileList() {
        ...
        if (!input) {
            console.error('Element mit ID "NewImages" nicht gefunden.');
            return;
        }
    ...
    const imagesElement = document.getElementById('NewImages');
    if (imagesElement) {
    ...
    // Bildvorschau Modal initialisieren (falls benötigt)
    window.showImagePreview = function (imageUrl) {
        console.log("showImagePreview aufgerufen mit URL:", imageUrl); // Debugging
